...
finity.theme = {
	main_container = Color3.fromRGB(40, 42, 54),
	separator_color = Color3.fromRGB(68, 71, 90),

	text_color = Color3.fromRGB(248, 248, 242),

	category_button_background = Color3.fromRGB(189, 147, 249),
	category_button_border = Color3.fromRGB(68, 71, 90),

	checkbox_checked = Color3.fromRGB(189, 147, 249),
	checkbox_outer = Color3.fromRGB(84, 81, 86),
	checkbox_inner = Color3.fromRGB(132, 132, 136),

	slider_color = Color3.fromRGB(177, 177, 177),
	slider_color_sliding = Color3.fromRGB(189, 147, 249),
	slider_background = Color3.fromRGB(88, 84, 90),
	slider_text = Color3.fromRGB(248, 248, 242),

	textbox_background = Color3.fromRGB(103, 103, 106),
	textbox_background_hover = Color3.fromRGB(189, 147, 249),
	textbox_text = Color3.fromRGB(248, 248, 242),
	textbox_text_hover = Color3.fromRGB(232, 232, 232),
	textbox_placeholder = Color3.fromRGB(137, 145, 148),

	dropdown_background = Color3.fromRGB(88, 88, 91),
	dropdown_text = Color3.fromRGB(248, 248, 242),
	dropdown_text_hover = Color3.fromRGB(189, 147, 249),
	dropdown_scrollbar_color = Color3.fromRGB(118, 118, 121),
	
	button_background = Color3.fromRGB(103, 103, 106),
	button_background_hover = Color3.fromRGB(189, 147, 249),
	button_background_down = Color3.fromRGB(189, 147, 249),
	
	scrollbar_color = Color3.fromRGB(68, 71, 90),
}
...
function finity.new(gprojectName, thinProject)
	...
	finityData = {
        ...
        CursorColor = Color3.fromRGB(128, 128, 128),
	}
	...
	self2.ShowCursor = function(NewColor)
		if NewColor ~= nil then
			finityData.CursorColor = NewColor
		end
		...
		self2.container.MouseEnter:Connect(function()
			self2.cursor.Visible = true
		end)
		self2.container.MouseLeave:Connect(function()
			self2.cursor.Visible = false
		end)
		
		local rs = self.gs["RunService"].RenderStepped:Connect(function()
    ...
    local parent = self2.userinterface
    local frame = self2.container
    ...
    frame.InputBegan:Connect(function(uis)
        if uis.UserInputType == Enum.UserInputType.MouseButton1 then
            ...
            uis.Changed:Connect(function()
                if uis.UserInputState == Enum.UserInputState.End then
                    dragging = false
                end
            end)
        end
    ...
    frame.InputChanged:Connect(function(uis)
        if uis.UserInputType == Enum.UserInputType.MouseMovement then
            dragInput = uis
        end
    end)

    uis.InputChanged:Connect(function(uis)
        if uis == dragInput and dragging then
            local delta = uis.Position - mousePos
